...
export const ATTACK_PROFILES: Record<string, AttackProfile> = {
  ...
  binary_search: {
    pose: 'shoot',
    basic: { behavior: 'projectile', pose: 'shoot', effect: 'arrow', range: 300, delay: 0.14, minRange: 92 },
    skills: [
      {
  ...
  kmp: {
    ...
    skills: [
      ...
      {
        id: 'kmp_next', name: 'next 跳转', description: '瞬步换位继续连击，命中不中断则势��破竹',
        behavior: 'dash', pose: 'slash', effect: 'slash',
  ...
  fft: {
    ...
    skills: [
      {
        id: 'fft_transform', name: '蝴蝶变换', description: '发射一道正弦波束，���透并共振路径上的敌人',
